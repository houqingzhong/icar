...
- (void)alignToTheRightOf:(UIView *)view withLeftPadding:(CGFloat)left bottomPadding:(CGFloat)bottom width:(CGFloat)width height:(CGFloat)height{
    self.frame = CGRectMake(CGRectGetMaxX(view.frame) + left, CGRectGetHeight(self.superview.frame) - height - bottom, width, height);
}
